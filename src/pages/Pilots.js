        ...
        <section>
            <div id='first' className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                ...
                <h2 className="font-extrabold md:text-3xl lg:text-4xl">Welcome to [D3s] Everywhere! Game</h2><br></br>
                                <img className="flex my-element mx-auto" src={pilot1} width="650" height="350"/><br></br><br></br>
                <div style={{textAlign: "justify"}}>
                ...
                <span>
                        ...
                        <img className="flex my-element mx-auto" src={pilot2} width="650" height="350"/><br></br><br></br>
                        ...
                        <img className="flex my-element mx-auto" src={pilot3} width="650" height="350"/><br></br><br></br>
