...
export default function Navbar(props) {
    ...
    return (<>
        <body id={"top"} className=" antialiased text-slate-500 dark:text-slate-400 dark:bg-slate-900 mt-0">
        <nav className="navbar">
            <div className="container flex justify-between items-center mx-auto max-w-8xl">
                ...
                <div
                    aria-expanded="false"
                    className={"fixed top-2 right-2 p-5 z-10 transition-all ease-in-out duration-300" + (navbarOpen ? " translate-x-0" : " translate-x-full")}
                    id="navbar-default"
                >
                    <button
