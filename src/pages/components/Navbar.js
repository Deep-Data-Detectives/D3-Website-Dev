...
export default function Navbar(props) {
    ...
    const menuItems = [{title: "How We Do It.", href: "/"}, {
        title: "Impact Areas.", href: "/pilots"
    }, {title: "What We Offer.", href: "/"}, {title: "Media.", href: "/media"}, {
        title: "Stay in Touch.", href: "/contact"
    }];
    return (<>
        ...
        >
            {menuItems.map((menu) => {
                return <SpeedDialAction icon={<HorizontalRuleIcon/>} sx={{marginY: "1.5rem"}}
                                        tooltipOpen tooltipTitle={menu.title} onClick={() => navigate(menu.href)}/>
            })}
