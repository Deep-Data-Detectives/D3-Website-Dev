    ...
    return (
        ...
        <nav className="navbar bg-gray-300 z-40 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 lg:border-b lg:border-slate-900/10 dark:border-slate-90/[0.06] bg-white/70 supports-backdrop-blur:bg-white/95 dark:bg-transparent hover:bg-gray-50">
            <div className="container flex flex-wrap justify-between items-center mx-auto max-w-8xl">
                ...
                <svg className="w-6 h-6" aria-hidden="true" fill="my-colour" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd"></path></svg>
                </button>
                <div className={
                ...
                <ul className={"flex flex-col p-2 mt-4 mr-5 bg-slate-0 md:flex-row md:space-x-8 md:mt-0"}>
                        ...
                        <li>
                            <Link to="" className={((selectd==='pilot_projects')? "block my-colour py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:dark:text-white md:text-black md:p-0 dark:text-white" : "block my-colour py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-black md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700")}>D3s Pilot Projects</Link>
                        </li>
                        <li>
                            <Link to="" className={((selectd==='join_us')? "block my-colour py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:dark:text-white md:text-black md:p-0 dark:text-white" : "block my-colour py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-black md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700")}>Join Us</Link>
                        </li>
                        <li>
                            <Link to="" className={((selectd==='about')? "block my-colour py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:dark:text-white md:text-black md:p-0 dark:text-white" : "block my-colour py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-black   md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700")}>About</Link>
                        </li>
                        </ul>
                </div>
            </div>
