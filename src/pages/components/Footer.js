    ...
    return (
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400">
                            ...
                            <li className="mb-4">
                                <HashLink className="hover:underline" to='./diversity#main'>Diversity and Inclusion</HashLink>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400">
                            <li className="mb-4">
                                <a href="https://www.facebook.com/nxtwave.founders" className="hover:underline ">Facebook</a>
                            </li>
                            <li className="mb-4">
                                <a href="https://www.instagram.com/nxtwavefounders/" className="hover:underline ">Instagram</a>
                            </li>
                            <li className="mb-4">
                                <a href="https://twitter.com/NxtWave_" className="hover:underline ">Twitter</a>
                            </li>
                            <li className="mb-4">
                                <a href="https://www.tiktok.com/@nxtwavefounders?lang=en" className="hover:underline ">TikTok</a>
                            </li>
                            <li className="mb-4">
        ...
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400"><a href="/"
                ...
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="https://www.facebook.com/nxtwave.founders" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <a href="https://www.instagram.com/nxtwavefounders/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fillRule="evenodd"
                    ...
                    <a href="https://twitter.com/NxtWave_" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path
                    ...
                    <a href="https://www.tiktok.com/@nxtwavefounders?lang=en" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
