...
const Home = () => {
        return (
          <div className='main-div'>
            <Navbar selected="home" />
              <section>
                  <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                      ...
                      <h1 className="my-colour font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">DEEP DATA DETECTIVES (D3)</h1><br></br>
                      <p className="mb-20 my-colour font-extrabold lg:text-xl">Driving Climate Action and Economic Prosperity for All with Data and AI</p>
            ...
            <iframe class = "my-element" src="https://drive.google.com/file/d/1T--HhzUOiygIKvUCjSzV2L4M_RedRXSQ/preview" width="750" height="450"></iframe><br></br>
            ...
            <div style={{zIndex: '0' }} className="flex flex-col mb-4 lg:mb-6 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
        ...
        <table className='tables1' style={{ borderCollapse: "collapse", margin: "auto", textAlign: "left" }}>
                ...
                <tbody>
                    <tr>
                    <td style={{  padding: "10px", verticalAlign: "top" }}><strong>Help Solve Community Problems</strong><br></br>

                    Capacity Building to mitigate and solve real-world issues while having fun and knowing what matters!
                    </td>
                    <td style={{  padding: "10px", verticalAlign: "top" }}><strong>Connect With The Resources You Need</strong><br></br>

                    Technical Assistance for Community Assessments, Asset Mapping and Service Networks.
                    </td>
                    <td style={{  padding: "10px", verticalAlign: "top" }}><strong>Beyond The Numbers</strong><br></br>

                    We help you stay relevant,  learn new skills.  Get the recognition you deserve while earning cash and rewards.  
                    </td>
                    </tr>
                </tbody>
                </table><br></br>
                ...
                <tbody>
                    <tr>
                    <td style={{  padding: "10px", verticalAlign: "top" }}>Grounded on research that translates into the field to break through barriers and reduce inequality.


                    </td>
                    <td style={{  padding: "10px", verticalAlign: "top" }}>The Initiative will go beyond our pilots to share our learnings and best practices with a global community.


                    </td>
                    <td style={{  padding: "10px", verticalAlign: "top" }}>Executing in alignment with an ecosystem of technical and strategic partners.

 
                    </td>
                    <td style={{  padding: "10px", verticalAlign: "top" }}>As AI shows great promise, Deep Data  Detectives principles align with human good intentions and values. 
