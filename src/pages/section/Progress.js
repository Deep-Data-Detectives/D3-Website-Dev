    ...
    return (<div id={"progress"} className="py-8 mx-auto text-center lg:py-16">
        ...
        <div className="grid-container ">
            <div className="grid-item ">
                ...
                <a target={'_blank'} className="my-colour underline " href="/pilots#first" rel="noopener noreferrer">
                    Learn about
                </a>{" "}
            ...
            <div className="grid-item ">
                ...
                <p><br/>
                    ...
                    immersive game-play.{" "}
                    <a target={'_blank'} className="my-colour underline" href="/pilots2#second" rel="noopener noreferrer"><br/>
                        Learn more
                    </a>
                </p>
            </div>
            <div className="grid-item ">
                ...
                <p>
                    ...
                    <a target={'_blank'} className="my-colour underline" href="/pilots3#third" rel="noopener noreferrer">
                        Learn more
                    </a>
                </p>
            </div>
